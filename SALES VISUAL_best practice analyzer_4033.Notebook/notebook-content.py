...
dataset = "SALES VISUAL" # Enter the name or ID of the semantic model
workspace = "ws-oralcare-analytics-dev" # Enter the workspace name or ID in which the semantic model exists
